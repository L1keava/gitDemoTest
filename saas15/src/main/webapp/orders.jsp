        ...
        <form action="${pageContext.request.contextPath }/showOrders" method="post">
            <table width="220px" border="1">
                ...
                <tr>
                    ...
                    <td>
                        <input name="orders[0].orderName" value="Java 基础教程" type="text">
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <input name="orders[0].orderId" value="2" type="text">
                    </td>
                    <td>
                        <input name="orders[0].orderName" value="JavaWeb 案例" type="text">
                    </td>
                    <td>
                    ...
                    <td>
                        <input name="orders[0].orderId" value="3" type="text">
                    </td>
                    <td>
                        <input name="orders[0].orderName" value="SSM 框架实战" type="text">
                    </td>
                    <td>
